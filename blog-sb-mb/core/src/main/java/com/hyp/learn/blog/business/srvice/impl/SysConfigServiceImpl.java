...
import com.hyp.learn.blog.business.consts.DateConst;
...
import com.hyp.learn.blog.framework.property.AppProperties;
import com.hyp.learn.blog.persistence.beans.SysConfig;
import com.hyp.learn.blog.persistence.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements SysConfigService {
    ...
    public void saveFile(String key, MultipartFile file) {
        ...
        if (file != null) {
            ...
            VFile virtualFile = uploader.upload(file, FileUploadType.QRCODE.getPath(), true);
