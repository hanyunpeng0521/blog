...
import com.hyp.learn.blog.business.enums.UserNotificationEnum;
import com.hyp.learn.blog.business.enums.UserPrivacyEnum;
import com.hyp.learn.blog.business.enums.UserStatusEnum;
...
import com.hyp.learn.blog.persistence.mapper.SysUserMapper;
    ...
    public boolean updateSelective(User user) {
        ...
        if (!StringUtils.isEmpty(user.getPassword())) {
            try {
                ...
                e.printStackTrace();
                throw new PxCommentException("密码加密失败");
            }
        } else {
