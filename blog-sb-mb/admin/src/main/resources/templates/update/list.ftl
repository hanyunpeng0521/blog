...
<@addOrUpdateMOdal defaultTitle="添加更新记录">
    ...
    <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="version">当前版本 <span
                    class="required">*</span></label>
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" class="form-control col-md-7 col-xs-12" name="version" id="version" required="required"
                   placeholder="请输入当前版本"/>
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <textarea class="form-control col-md-7 col-xs-12" id="description" name="description" required="required"
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class='input-group date' id='myDatepicker'>
                <input type='text' class="form-control" required="required" readonly="readonly" id="recordeTime"
                       name="recordeTime" placeholder="请输入维护日期"/>
