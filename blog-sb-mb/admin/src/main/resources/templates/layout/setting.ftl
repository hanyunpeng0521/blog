                                ...
                                <#if getNewCommentInfo['total'] gt 0>
                                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                        <#list getNewCommentInfo["comments"] as item>
                                            <li>
                                                <a href="/comments">
                                                    <span class="image"><img src="${item.avatar}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">捐赠博主
                        <small>码代码很累的！天热了，请作者吃根冰棍儿吧！<i class="fa fa-smile-o"></i></small>
                    </h4>
                </div>
                <div class="modal-body">
                    <div class="col-sm-12 col-md-12" style="text-align: center;margin: 0 auto;float: initial">
                        <a href="/assets/images/reward/zfb_code.png" class="showImage" title="支付宝收钱码"
                           rel="external nofollow">
                            <img src="/assets/images/reward/zfb_code.png" alt="支付宝收钱码" class="img-rounded"
                                 style="width: 250px;height: auto;">
                        </a>
                        <a href="/assets/images/reward/wx_code.png" class="showImage" title="微信收钱码"
                           rel="external nofollow">
                            <img src="/assets/images/reward/wx_code.png" alt="微信收钱码" class="img-rounded"
                                 style="width: 250px;height: auto">
                        </a>
                    </div>
