        ...
        <div class="x_panel">
            ...
            <div class="x_content" style="display: flex;justify-content: center;">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-whatsapp"></i> 聊天
                                <small>socket通信，当前在线: ${online!("0")}</small>
                            </h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li></li>
                            </ul>
                        ...
                        <div class="x_content">
                            <div class="messanger">
                                ...
                                <div class="sender">
                                    ...
                                    <button class="btn btn-primary" id="send-btn" type="button" style="margin: 0;"><i
