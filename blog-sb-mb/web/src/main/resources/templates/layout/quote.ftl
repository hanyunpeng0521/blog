...
<link href="${config.staticWebSite}/css/px.core.css" rel="stylesheet" type="text/css">
<link href="${config.staticWebSite}/css/px.comment.css" rel="stylesheet" type="text/css">