            ...
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <p>托管于<a href="https://promotion.aliyun.com/ntms/act/ambassador/sharetouser.html"
                         ...
                         rel="external nofollow">阿里云</a> & <a href="https://portal.qiniu.com/signup" target="_blank"
                                                              ...
                                                              rel="external nofollow">七牛云</a><#if config.recordNumber!> ·
                ...
                <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a
                            href="https://github.com/hanyunpeng0521/blog/tree/master/blog-sb-mb"
                            title="PxBlog是一款简洁美观、自适应的Java博客系统" data-toggle="tooltip" data-placement="right"
                            target="_blank"><i>OneBlog</i></a></p>
                <#if url?? && (url == "index")>
