...
<@compress single_line=false>
                    ...
                    <div class="blog-info overflow-initial">
                        <div class="bottom-line">
                            ...
                            <@zhydTag method="siteInfo">
                                <div class="archives-meta"> 站点统计：${siteInfo.typeCount!(0)}
                                    个分类&nbsp;&nbsp; ${siteInfo.tagCount!(0)}个标签&nbsp;&nbsp; ${siteInfo.articleCount!(0)}
                                    篇文章&nbsp;&nbsp; ${siteInfo.commentCount!(0)}条留言&nbsp;&nbsp;
                                    最后更新：${siteInfo.lastUpdateTime} </div>
                            </@zhydTag>
                                                            ...
                                                            <ul class="list-box" style="display: none;">
                                                                <#list archives[dateTime] as article>
                                                                    <li class="article-item"><a
                                                                                href="${config.siteUrl}/article/${article.id?c}"
                                                                                rel="bookmark" title=""
                                                                                data-toggle="tooltip"
                                                                                data-placement="bottom"
                                                                                data-original-title="${article.title}">${article.title}</a>
                                                                    </li>
                                                                </#list>
                                                            </ul>
                                                        </li>
    ...
    <@footer>
        ...
        <script src="https://v1.hitokoto.cn/?encode=js&c=d&select=.hitokoto%27);dom=$('.hitokoto');for(var i=0;i<dom.length;i%2B%2B){dom[i].innerText=hitokoto;}})()//"
                defer></script>
    </@footer>
</@compress>