                    ...
                    <#list list as item>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a class="panel-title" data-toggle="collapse" data-parent="#updatelog-body"
                                   href="#panel-element-${item.id?c}"
                                   contenteditable="true">${item.recordeTime?string('yyyy年MM月dd日 HH时')}
                                    v${item.version}</a>
                            </div>
