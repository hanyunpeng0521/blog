<#-- 公共顶部 -->
<#macro header title="PxBlog博客" keywords="" description="" canonical="" hasEditor=false>
    ...
    <head>
        ...
        <#if hasEditor>
            ...
            <link href="https://cdn.jsdelivr.net/npm/github-markdown-css@2.10.0/github-markdown.min.css"
                  rel="stylesheet">
...
<#macro praise>
    <#if config.wxPraiseCode! || config.zfbPraiseCode!>
        <h5 class="custom-title"><i class="fa fa-dollar fa-fw"></i><strong>鼓励一下</strong>
            <small></small>
        </h5>
