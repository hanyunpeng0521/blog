...
<#if article.coverImage??>
    <img src="${article.coverImage!}" onerror="this.src='${config.staticWebSite}/img/default_article_cover.jpg'"
...
<div class="container custome-container">
    ...
    <div class="row article-body">
        <div class="col-sm-8 blog-main">
                        ...
                        <div class="social-main">
                            <span class="like">
                                <a href="javascript:;" data-id="${article.id?c}" title="点赞"><i
                                            class="fa fa-thumbs-up"></i>赞 <i class="count"> ${article.loveCount!(0)}</i> </a>
                            </span>
                            <div class="shang-p">
                ...
                <div class="cat">
                    <ul class="list-unstyled">
                        <li>
                            ...
                            <#else>
                                <a href="javascript:;;" class="c-label" data-original-title="暂无相关标签"
                                   data-toggle="tooltip" data-placement="bottom" target="_blank">暂无相关标签</a>
                            </#if>
                        </li>
                        <li>
                            <strong>版权声明：</strong>
                            ...
                            <#else>
                                本文为互联网转载文章，出处已在文章中说明(部分除外)。如果侵权，请<a target="_blank" href="mailto:${config.authorEmail}"
            ...
            <div class="blog-body">
                <a href="https://promotion.aliyun.com/ntms/act/ambassador/sharetouser.html?userCode=wylo59db&utm_source=wylo59db"
                   target="_blank" rel="external nofollow">
                    <img src="${config.staticWebSite}/img/ad/aliyun_sale1000-60.png" alt="阿里云首购8折"
            ...
            <div class="blog-body clear overflow-initial">
                <h5 class="custom-title"><i class="fa fa-fire fa-fw icon"></i><strong>热门推荐</strong>
                    <small></small>
                </h5>
                <ul class="list-unstyled">
                                ...
                                <li class="line-li">
                                    <div class="line-container">
                                        <div class="line-left">
                                            ...
                                            <#else>
                                                <img class="lazy-img"
                                                     <#if config.lazyloadPath!>data-original<#else>src</#if>="${config.staticWebSite}/img/favicon.ico"
                                                     width="50" height="50" rel="external nofollow"/>
                                            </#if>
                                        </div>
                                        <div class="line-right">
                                            <div class="text">
                                                <a href="${config.siteUrl}/article/${item.id?c}"
                                                   data-original-title="${item.lookCount?c}人浏览了该文章"
                                            ...
                                            <div class="text">
                                                ...
                                                <span class="views" title="" data-toggle="tooltip"
                                                      data-placement="bottom" data-original-title="文章阅读次数"><i
                                                            class="fa fa-eye fa-fw"></i>浏览(${item.lookCount!(0)})</span>
                                                <span class="comment" title="" data-toggle="tooltip"
                                                      data-placement="bottom" data-original-title="文章评论次数">
            ...
            <#-- 相关文章 -->
            <div class="blog-body clear overflow-initial">
                <h5 class="custom-title"><i class="fa fa-google-wallet fa-fw icon"></i><strong>相关文章</strong>
                    <small></small>
                </h5>
                <ul class="list-unstyled">
